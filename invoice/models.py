...
class Client(models.Model):
    ...
    # Basic Fields.
    # todo: Fakturační údaje - firma, jmeno, Přijmení, ulice, mesto, PSČ, Země, Web, IČ, DIČ
    # todo: dodací údaje - Název firmy, ulice, město, PSČ, Jméno, přijmení, země, Telefon
    # todo: kontaktí údaje - email, kopie email, telefon
    ...
    dic = models.CharField(null=True, blank=True, max_length=100)
