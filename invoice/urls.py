...
from . import views
from .views import DeleteInvoiceConfirmView, delete_invoice
...
path('invoices/confirm-delete/<slug:slug>/', DeleteInvoiceConfirmView.as_view(), name='invoice-confirm-delete'),
path('invoices/delete/<slug:slug>/', delete_invoice, name='delete-invoice'),
